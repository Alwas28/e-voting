...
<div id="app" class="flex min-h-screen">
  ...
  <aside id="sidebar" class="sidebar-surface fixed lg:static inset-y-0 left-0 z-40 w-64 transform -translate-x-full lg:translate-x-0 transition-transform duration-200 flex flex-col">
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
      ...
      {{-- Hasil Voting: akses dikontrol via permission 'election.results' (atur di Role & Akses) --}}
      ...
      <a href="{{ route('admin.formateurs.index') }}"
         class="nav-item {{ request()->routeIs('admin.formateurs*') ? 'is-active' : '' }} flex items-center gap-3 px-3 py-2.5 rounded-lg">
  ...
  <div class="flex-1 flex flex-col min-w-0">
    ...
    <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 sticky top-0 z-20">
      <div class="flex items-center gap-3">
        ...
        {{-- Logo hanya tampil di mobile, di samping hamburger --}}
        <img src="{{ asset('images/Logo2.png') }}" alt="Logo" class="lg:hidden w-8 h-8 object-contain" />
